 ...
 */
public class ContractForForcast {
 ...
 Uri loaction_return=CONTENT_URI.buildUpon().appendPath(locationSetting).build();
        return loaction_return;
    }
    ...
    public static String getLocationSettingFromUri(Uri uri) {
               ...
               String helo_return;
        helo_return = uri.getPathSegments().get(1);
        return helo_return;
